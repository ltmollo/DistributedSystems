...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default double avg(long[] s)
        throws EmptySequence
    {
        return avg(s, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default double avg(long[] s, java.util.Map<String, String> context)
        throws EmptySequence
    {
        try
        {
            return _iceI_avgAsync(s, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Double> avgAsync(long[] s)
    {
        return _iceI_avgAsync(s, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> avgAsync(long[] s, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(s, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> _iceI_avgAsync(long[] iceP_s, java.util.Map<String, String> context, boolean sync)
    {
