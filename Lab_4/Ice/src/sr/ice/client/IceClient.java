...
public class IceClient {
	public static void main(String[] args) {
		...
		String[] arg = {"--Ice.Config=config.client"};
		try {
			// 1. Inicjalizacja ICE
			communicator = Util.initialize(arg);
			...
			ObjectPrx base2 = communicator.stringToProxy("calc/calc11:tcp -h 127.0.0.2 -p 10000 -z : udp -h 127.0.0.2 -p 10000 -z");
