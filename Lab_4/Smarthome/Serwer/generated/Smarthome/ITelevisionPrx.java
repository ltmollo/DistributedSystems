...
public interface ITelevisionPrx extends ISpeakerPrx
{
    default Channel getChannel()
    {
        return getChannel(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default Channel getChannel(java.util.Map<String, String> context)
    {
        return _iceI_getChannelAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Channel> getChannelAsync()
    {
        return _iceI_getChannelAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Channel> getChannelAsync(java.util.Map<String, String> context)
    {
        return _iceI_getChannelAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Channel> _iceI_getChannelAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Channel> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getChannel", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
    ...
    default java.util.List<Channel> getChannels(java.util.Map<String, String> context)
    {
        return _iceI_getChannelsAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.util.List<Channel>> getChannelsAsync()
    {
        return _iceI_getChannelsAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.util.List<Channel>> getChannelsAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.util.List<Channel>> _iceI_getChannelsAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.util.List<Channel>> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getChannels", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     java.util.List<Channel> ret;
                     ret = channelsHelper.read(istr);
                     return ret;
                 });
        return f;
    }

    default boolean setChannel(Channel channel)
        throws InvalidChannelException
    {
        return setChannel(channel, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default boolean setChannel(Channel channel, java.util.Map<String, String> context)
        throws InvalidChannelException
    {
        try
        {
            return _iceI_setChannelAsync(channel, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Boolean> setChannelAsync(Channel channel)
    {
        return _iceI_setChannelAsync(channel, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> setChannelAsync(Channel channel, java.util.Map<String, String> context)
    {
        return _iceI_setChannelAsync(channel, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> _iceI_setChannelAsync(Channel iceP_channel, java.util.Map<String, String> context, boolean sync)
    {
        ...
        f.invoke(true, context, null, ostr -> {
                     Channel.ice_write(ostr, iceP_channel);
                 }, istr -> {
                     boolean ret;
                     ret = istr.readBool();
                     return ret;
